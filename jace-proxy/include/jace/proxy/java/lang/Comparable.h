...
class Comparable: public virtual ::jace::proxy::java::lang::Object
{
   ...
   */
  JACE_PROXY_API explicit Comparable();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API Comparable(const Comparable&);
  /**
   * compareTo
   */
  JACE_PROXY_API ::jace::proxy::types::JInt compareTo(::jace::proxy::java::lang::Object p0);
  ...
  JACE_PROXY_API explicit Comparable(jvalue);
  JACE_PROXY_API explicit Comparable(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::Comparable >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::lang::Comparable >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
