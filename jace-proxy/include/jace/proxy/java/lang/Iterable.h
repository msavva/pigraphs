...
class Iterable: public virtual ::jace::proxy::java::lang::Object
{
   ...
   */
  JACE_PROXY_API explicit Iterable();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API Iterable(const Iterable&);
  ...
  JACE_PROXY_API explicit Iterable(jvalue);
  JACE_PROXY_API explicit Iterable(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::Iterable >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::lang::Iterable >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
