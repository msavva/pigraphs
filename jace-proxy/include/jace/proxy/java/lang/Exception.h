...
class Exception: public ::jace::proxy::java::lang::Throwable
{
  ...
  public:
     ...
     */
    JACE_PROXY_API static Exception create();
    /**
     * Creates a new Exception.
     */
    JACE_PROXY_API static Exception create(::jace::proxy::java::lang::String p0);
    /**
     * Creates a new Exception.
     */
    JACE_PROXY_API static Exception create(::jace::proxy::java::lang::String p0, ::jace::proxy::java::lang::Throwable p1);
    /**
     * Creates a new Exception.
     */
    JACE_PROXY_API static Exception create(::jace::proxy::java::lang::Throwable p0);
  };
   ...
   */
  JACE_PROXY_API explicit Exception();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API Exception(const Exception&);
  ...
  JACE_PROXY_API explicit Exception(jvalue);
  JACE_PROXY_API explicit Exception(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::Exception >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::lang::Exception >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
