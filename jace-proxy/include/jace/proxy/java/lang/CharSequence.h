...
class CharSequence: public virtual ::jace::proxy::java::lang::Object
{
   ...
   */
  JACE_PROXY_API explicit CharSequence();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API CharSequence(const CharSequence&);
  /**
   * length
   */
  ...
  JACE_PROXY_API explicit CharSequence(jvalue);
  JACE_PROXY_API explicit CharSequence(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::CharSequence >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::lang::CharSequence >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
