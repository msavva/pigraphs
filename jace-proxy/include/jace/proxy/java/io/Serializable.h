...
class Serializable: public virtual ::jace::proxy::java::lang::Object
{
   ...
   */
  JACE_PROXY_API explicit Serializable();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API Serializable(const Serializable&);
  ...
  JACE_PROXY_API explicit Serializable(jvalue);
  JACE_PROXY_API explicit Serializable(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::io::Serializable >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::io::Serializable >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
