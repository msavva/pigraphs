...
class AbstractCollection: public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::util::Collection
{
   ...
   */
  JACE_PROXY_API explicit AbstractCollection();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API AbstractCollection(const AbstractCollection&);
  /**
   * size
   */
  ...
  JACE_PROXY_API explicit AbstractCollection(jvalue);
  JACE_PROXY_API explicit AbstractCollection(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::util::AbstractCollection >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::util::AbstractCollection >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
