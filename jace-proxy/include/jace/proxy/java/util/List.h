...
class List: public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::util::Collection
{
   ...
   */
  JACE_PROXY_API explicit List();
  /**
   * Copy an existing reference.
   */
  JACE_PROXY_API List(const List&);
  /**
   * size
   */
  ...
  JACE_PROXY_API explicit List(jvalue);
  JACE_PROXY_API explicit List(jobject);
private:
  /**
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::util::List >::JFieldProxy(jfieldID _fieldID, jvalue value, jobject _parent);
  template <> JFieldProxy< ::jace::proxy::java::util::List >::JFieldProxy(jfieldID _fieldID, jvalue value, jclass _parentClass);
